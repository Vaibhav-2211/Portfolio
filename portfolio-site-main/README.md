...
1. Clone the repository:
   ```bash
   git clone https://github.com/Vaibhav-2211/portfolio-site.git
   ```
...
- **Email**: [vaibhavkhandelwal.it27@gmail.com](mailto:vaibhavkhandelwal.it27@gmail.com)
- **LinkedIn**: [vaibhav-khandelwal-it](https://www.linkedin.com/in/vaibhav-khandelwal-it)
- **GitHub**: [Vaibhav-2211](https://github.com/Vaibhav-2211)
