...
export class SeoService {
      ...
      .subscribe(route => {
        ...
        if (routeData) {
          ...
          this.updatePageMetadata({
            title: routeData['title'] || 'Vaibhav Khandelwal | Aspiring Technology Professional | Portfolio',
            description: routeData['description'] || 'Aspiring technology professional portfolio',
  ...
  updatePageMetadata(metadata: PageMetadata): void {
    ...
    const formattedTitle = metadata.title === 'Home'
      ? 'Vaibhav Khandelwal | Aspiring Technology Professional | Portfolio'
  ...
  updateTitle(title: string): void {
    const formattedTitle = title === 'Home'
      ? 'Vaibhav Khandelwal | Aspiring Technology Professional'
      : `${title} – ${this.siteName}`;
    this.title.setTitle(formattedTitle);
  }
  ...
  updateSeoForRoute(route: string, metadata: Partial<PageMetadata>): void {
    ...
    this.updatePageMetadata({
      title: metadata.title || 'Vaibhav Khandelwal | Full-Stack Developer | Angular & .NET Expert | Portfolio',
